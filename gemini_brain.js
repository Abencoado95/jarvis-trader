...
class GeminiBrain {
    ...
    analyzeDigitsLocal(tech, mode) {
        ...
        if (mode === 'OVER_UNDER') {
            // ESTRATÉGIA SEGURA (3 Seguidos) - Solicitado pelo usuário
            // Espera sequência de 3 dígitos BAIXOS (0,1,2,3,4) -> Entra OVER 5
            ...
            if (sequenceLow) {
                ...
                reason = `Aguardando padrão (3 seguidos)... Últimos: [${digits.slice(-5).join(', ')}]`;
            }
